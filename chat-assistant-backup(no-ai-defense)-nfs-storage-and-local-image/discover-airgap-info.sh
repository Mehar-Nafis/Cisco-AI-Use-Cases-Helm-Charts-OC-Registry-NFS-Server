...
1. Take the llama/content/topicControl snapshot paths from section 1,
   ...
   Confirmed live (2026-07-20, sibling chat-assistant-integrated-with-
   ai-defense chart) — this is the genuine nim_llm_sdk bypass, same
   mechanism as insurguard's llama-parser.
